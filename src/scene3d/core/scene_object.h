...
protected:
    SceneObject(RenderImplementation* impl, QObject *parent = nullptr, QString name = QStringLiteral("Scene object"));

    SceneObject(RenderImplementation* impl, GraphicsScene3dView* view = nullptr,
                QObject *parent = nullptr, QString name = QStringLiteral("Scene object"));

                ...
                RowLayout {
                    ...
                    CCombo  {
                        ...
                        onActivated: {
                            ...
                            console.log(baudrateCombo.currentText)
                        }
                    ...
                    CButton {
                        ...
                        onClicked: {
                            if (ConnectionStatus) {
                                ...
                                case 2:
                                    core.closeLogFile();
                                    linkManagerWrapper.openAsUdp(Uuid, ipAddressText.text,
                                                                 Number(ipPortText.text), Number(ipPort2Text.text))
                                    break
                                case 3:
                                    core.closeLogFile();
                                    linkManagerWrapper.openAsTcp(Uuid, ipAddressText.text,
                                                                 Number(ipPortText.text), Number(ipPort2Text.text))
                                    break
                                default:
